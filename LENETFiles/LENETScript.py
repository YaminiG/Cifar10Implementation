...
#plt.imshow(sample_image)
X_test = features[0:9999]
y_test = labels[0:9999]
X_test.shape
...
a = tf.placeholder(tf.float32, (9999,32,32,3))
...
###### LAYER 1 ######
valuesConvMat, valuesFcMat, numImg = loadValues(9999)
...
## fully connected outputs are getting saved here
np.savetxt('mefc1.txt', MEFullyConnected1Graphs[0], delimiter=',') ## STATIC
np.savetxt('mefc11.txt', MEFullyConnected1Graphs[1], delimiter=',') ## DYNAMIC
np.savetxt('mefc2.txt', MEFullyConnected2Graphs[0], delimiter=',') ## STATIC
np.savetxt('mefc21.txt', MEFullyConnected2Graphs[1], delimiter=',') ## DYNAMIC
np.savetxt('mefc3.txt', MEFullyConnected3Graphs[0], delimiter=',') ## STATIC
np.savetxt('mefc31.txt', MEFullyConnected3Graphs[1], delimiter=',') ## DYNAMIC


##convolution outputs are getting saved here
np.savetxt('meconv1.txt', MEConv1Graphs[0], delimiter=',') ## STATIC
np.savetxt('meconv11.txt', MEConv1Graphs[1], delimiter=',') ## DYNAMIC
np.savetxt('meconv2.txt', MEConv2Graphs[0], delimiter=',') ## STATIC
np.savetxt('meconv21.txt', MEConv2Graphs[1], delimiter=',') ## DYNAMIC
